 ...
 * Modified by Michał Stoń <michal.ston@mobica.com> 
 * for the purpose of calculating CRC-32 from a buffer
 */
...
static uint32_t crc32(uint32_t crc, const uint8_t* buff, uint32_t len)
{
    const uint8_t *p ;
